  ...
  return (
    <>
      <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
        ...
        <nav>
          <h6 className="text-white text-2xl mb-3">Product</h6>
        ...
        <nav>
          <h6 className="text-white text-2xl mb-3">Company</h6>
        ...
        <nav>
          <h6 className="text-white text-2xl mb-3">Resources</h6>
        ...
        <nav>
          <h6 className="text-white text-2xl mb-3">Social Links</h6>
      ...
      <div className="bg-base-200">
        <div className="border-t border-gray-700 px-10 py-4 flex flex-col md:flex-row justify-between items-center md:mx-20">
        ...
        <div className="flex gap-6 mt-2 md:mt-0">
          ...
          <a className="text-gray-400 hover:text-white text-sm">Cookies</a>
        </div>
        </div>
      </div>
    </>
