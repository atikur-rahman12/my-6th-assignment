...
const Counter = () => {
  return (
    <div className="bg-linear-to-r from-indigo-600 to-purple-500 w-full py-12 px-8 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 lg:gap-20 mb-25 ">
