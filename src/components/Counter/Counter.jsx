...
const Counter = () => {
  return (
    <div className="bg-linear-to-r from-indigo-600 to-purple-500 w-full py-12 px-8 flex flex-col md:flex-row items-center justify-center gap-18 md:gap-30 mb-25">
