...
const PricingCard = ({ pricing, handleAddToCart, buttonStyle }) => {
  ...
  return (
    <div className="card w-full max-w-md mx-auto bg-base-100 shadow-sm mt-5 border border-gray-700 transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-lg">
